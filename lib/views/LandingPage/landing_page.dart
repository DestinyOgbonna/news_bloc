...
import 'package:news_bloc/bloc/game_data_bloc.dart';
import 'package:news_bloc/models/data_model.dart';
import 'package:news_bloc/routes/router.dart';
      ...
      body: BlocBuilder<GameDataBloc, GameDataState>(
        builder: (context, state) {
          if (state is GameDataInitialState) {
            //if the state is at a initial state load the gameData fom the api
