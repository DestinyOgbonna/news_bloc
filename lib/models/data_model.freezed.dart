...
class _$_DataModel implements _DataModel {
  ...
  @override
  String toString() {
    return 'DataModel(id: $id, users: $users, worth: $worth, thumbnail: $thumbnail, image: $image, description: $description, instructions: $instructions, title: $title, open_giveaway_url: $open_giveaway_url, published_date: $published_date, type: $type, platforms: $platforms, end_date: $end_date, status: $status, gamerpower_url: $gamerpower_url)';
  }
